...
const myIcon4 = "";
const myIcon5 =
  "M20 8v2h6.586L18 18.586l-4.293-4.293a1 1 0 0 0-1.414 0L2 24.586L3.414 26L13 16.414l4.293 4.293a1 1 0 0 0 1.414 0L28 11.414V18h2V8Z";
        ...
        <ul className="space-y-4 ">
          <li className="flex items-center">
            ...
            <p className="text-lg">
              ...
              Infrastructure, and more. Our clients are looking for the best,
          ...
          <li className="flex items-center">
            ...
            <p className="text-lg">
              ...
              lifestyle. You decide when and how much you want to work, giving
          ...
          <li className="flex items-center">
            ...
            <p className="text-lg">
              ...
              projects, and enhance your skills through knowledge transfer
              opportunities.
            </p>
          </li>
          <li className="flex items-center">
            ...
            <p className="text-lg">
              ...
              digital onboarding process is designed to be quick and efficient,
          ...
          <li className="flex items-center">
            ...
            <p className="text-lg">
              ...
              is making a real difference by solving the talent scarcity
              challenge in one of the fastest-growing tech markets in the world.
            </p>
          </li>
        </ul>
      </div>
