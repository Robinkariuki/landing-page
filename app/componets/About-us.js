...
const AboutUs = () => {
  return (
    <div className="lg:pl-64  lg:pt-16 text-balance bg-white text-center"  style={{height:596}}>
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-row md:flex-row md:justify-between gap-x-4 p-4 mr-0 md:mr-96">
  <div className='flex flex-col gap-y-4'>
    <Image
      ...
      width={323}
      height={309}
      className=" w-[174px] h-[163px]  md:w-[323px] md:h-[309px]"
    />
    <Image
      ...
      width={323}
      height={224}
      className=" w-[174px] h-[96px]  md:w-[323px] md:h-[224px]"
    />
  </div>
  <div className='flex flex-col gap-y-4'>
    <Image
